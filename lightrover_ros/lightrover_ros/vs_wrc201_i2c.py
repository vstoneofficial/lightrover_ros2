...
#±ÌCuÍAVS-WRC201ÆI2CÊMðs¤½ßÌàÌÅ·B
...
class VsWrc201I2c:
        ...
        #VS-WRC201ãÌ}CRÌ}bvÌÁèAhXðã«i1bytej
        def write_1_byte(self,addr,data):
                self.__i2c.write_byte_data(self.DEV_ADDR,addr,data)

                return 1

        #VS-WRC201ãÌ}CRÌ}bvÌÁèAhXðã«i2bytej
        ...
        #VS-WRC201ãÌ}CRÌ}bvÌÁèAhXðã«i4bytej
        ...
        #VS-WRC201ãÌ}CRÌ}bvÌÁèAhX©çwèoCgªã«
        ...
        #VS-WRC201ãÌ}CRÌ}bvÌÁèAhX©çwèoCgªÇÝÝ
        #YpCÌ}bvÖ½f
        ...
        def read_multi_memmap(self,addr,length):
                read_data = self.__i2c.read_i2c_block_data(self.DEV_ADDR, addr, length)
                #àµÇÝñ¾f[^ª·×Ä0xFF¾Á½êAI2CÊMÌG[ÌÂ\«ª é½ßà¤êxÇÝÞ
                if all(byte == 0xFF for byte in read_data):
                        time.sleep(0.01)
                        read_data = self.__i2c.read_i2c_block_data(self.DEV_ADDR, addr, length)
                self.memmap[addr:addr+length] = read_data

                return 1

        #VS-WRC201ãÌ}CRÌ}bvð·×ÄÇÝÝ
        #YpCÌ}bvÖ½f
        def read_all(self):
        ...
        #YpCãÌ}bvðVS-WRC201Ì}CRÌ}bvÖ½f
        ...
        #YpCÌ}bvÌÇÝÝi1bytej
        def read_s8map(self,addr):
                return self.memmap[addr]

        #YpCÌ}bvÌã«i1bytej
